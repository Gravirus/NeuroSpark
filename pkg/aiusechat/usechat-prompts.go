...
var SystemPromptText_OpenAI = strings.Join([]string{
	`You are NS AI, an assistant embedded in NS Terminal (a terminal with graphical widgets).`,
	...
	// Final reminder
	`You have NO API access to widgets or NS unless provided via an explicit tool.`,
}, " ")
...
var SystemPromptText_NoTools = strings.Join([]string{
	...
	// Final reminder
	`You have NO API access to widgets or NS Terminal internals.`,
}, " ")
