            ...
            <div className="flex items-center justify-center p-8 text-center">
                <div className="max-w-md space-y-6">
                    <div className="space-y-4">
                        ...
                        <h2 className="text-2xl font-semibold text-foreground">NeuroSpark AI</h2>
                        <p className="text-secondary leading-relaxed">
                            NeuroSpark AI is a Wave Terminal-based app that provides a built-in AI chat that can
                            interact with windows in your environment, assist you with code, analyze files and the
                            browser, and provide project support. It has added many new features, fine-tuning models,
                            and a dedicated app-building mode on Tsunami.
                        </p>
                    </div>
                    ...
                    <div className="bg-blue-900/20 border border-blue-500 rounded-lg p-4">
                        <div className="flex items-start gap-3">
                            ...
                            <div className="text-left">
                                <div className="text-blue-400 font-medium mb-1">Telemetry keeps NeuroSpark AI free</div>
                                <div className="text-secondary text-sm mb-3">
                                    <p className="mb-2">
                                        To keep NeuroSpark AI free for everyone, we require a small amount of{" "}
                                    ...
                                    <p className="mb-2">
                                        ...
                                        identifying information. NeuroSpark AI is powered by OpenAI's APIs, please refer
                                        to OpenAI's privacy policy for details on how they handle your data.
                                    </p>
                                    <p>
