        ...
        <div className="bg-blue-900/20 border border-blue-800 rounded-lg p-4 mt-4">
            <div className="flex items-start gap-3">
                ...
                <div className="text-left flex-1">
                    <div className="text-blue-400 font-medium mb-1">API & Local AI Support</div>
                    <div className="text-secondary text-sm mb-3">
                        NeuroSpark AI supports native API keys from OpenAI, Google Gemini, Azure, and OpenRouter, as
                        well as local models through Ollama, LM Studio, and other OpenAI-compatible providers.
                    </div>
